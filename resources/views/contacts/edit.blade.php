...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="card pb-3">
                <div class="card-header">Editare Contact</div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('contacts.update', $contact->id) }}" method="POST">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id="nume" class="form-control @error('nume') is-invalid @enderror" name="nume" autocomplete="off" placeholder="ex. Popescu" value="{{old('nume', $contact->nume)}}">
                            @error('nume')
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id="prenume" class="form-control @error('prenume') is-invalid @enderror" name="prenume" autocomplete="off" placeholder="ex. Ion" value="{{old('prenume', $contact->prenume)}}">
                            @error('prenume')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" id="email" class="form-control @error('email') is-invalid @enderror" name="email" autocomplete="off" placeholder="ex .popescu.ion@gmail.com" value="{{old('email', $contact->email)}}">
                            @error('email')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group mt-2">
                            ...
                            <select name="sex" id="sex" class="form-select form-control @error('sex') is-invalid @enderror">
                                ...
                                <option value="M" @if( old('sex') == 'M' || $contact->sex == 'M') selected @endif>Masculin</option>
                                <option value="F" @if( old('sex') == 'F' || $contact->sex == 'F') selected @endif>Feminim</option>
                            </select>
                            @error('sex')
                                <span class="invalid-feedback">
                                    {{ $message }}
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="cnp" class="form-control @error('cnp') is-invalid @enderror" name="cnp" autocomplete="off" placeholder="Codul Numeric Personal" value="{{old('cnp', $contact->cnp)}}" maxlength="13">
                            @error('cnp')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="data_nastere" class="form-control datepicker @error('data_nastere') is-invalid @enderror" name="data_nastere" autocomplete="off" placeholder="AAAA-LL-ZZ" value="{{old('data_nastere', $contact->data_nastere)}}" readonly>
                            @error('data_nastere')
                                <span class="invalid-feedback">
                                    {{ $message }}
                                </span>
                        ...
                        @else
                            ...
                            <div class="mt-3">
                                <label for="telefon">Nr. de telefon (<span id="countTelefon">{{count($contact->phones)}}</span>) </label>
                            </div>

                            <div id="telefon_box" class="form-group">

                                @if(count($contact->phones))
                                    @foreach ($contact->phones as $k => $phones)
                                        <div class="telefon_item" data-id="{{++$k}}">

                                            <div class="input-group mb-2">
                                                <input type="text" class="form-control form-control-sm" name="telefon[{{$k}}]" autocomplete="off" placeholder="07XXXXXXXX" maxlength="10" value="0{{$phones->number}}">
                                                <button class="btn btn-sm btn-danger minus" type="button"><i class="bi bi-trash"></i></button>
                                            </div>
                        ...
                        <div class="form-group d-flex justify-content-between mt-4">
                            ...
                            <button type="submit" class="btn btn-sm btn-primary" id="submit">Salveaza</button>
                        </div>
                    </form>
